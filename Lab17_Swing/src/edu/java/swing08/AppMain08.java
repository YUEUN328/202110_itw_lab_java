...
public class AppMain08 {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 354, 503);
		...
		btnMsgDlg.setBounds(12, 10, 314, 51);
		...
		btnConfirmDlg.setBounds(12, 71, 314, 51);
		...
		btnOptionDlg.setBounds(12, 132, 314, 51);
...
//				String input = JOptionPane.showInputDialog(frame, "이름은?");
				...
				// showInputDialog(parentComponent, message, initialSelctionValue)
//				String input = JOptionPane.showInputDialog(frame, "나이는?", 0);
		...
		btnInputDlg.setBounds(12, 193, 314, 51);
		...
		btnCustomDlg.setBounds(12, 254, 314, 51);
		...
		btnCustomFrame.setBounds(12, 315, 314, 51);
