...
public class AppMain10 {
	...
	private void initialize() {
		...
		textField.setBounds(14, 12, 248, 43);
		...
		btnInput.setBounds(290, 12, 128, 43);
		...
		btnDelete.setBounds(290, 67, 128, 43);
		frame.getContentPane().add(btnDelete);
		
		scrollPane = new JScrollPane();
		scrollPane.setBounds(14, 67, 248, 174);
	...
	private void deleteElementFromList() {
		...
		// 선택된 아이템이 있다면, 정말로 삭제할 것인지를 확인한 후 
